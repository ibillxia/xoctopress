---   
layout: post   
title: "神策分析的技术选型与架构实现"   
date: 2016-11-15 21:17   
comments: true   
categories: Engineering   
tags: 数据分析 架构 OLAP Impala 大数据   
---   

<center>{% img /images/2016/IMAG2016111500.png %}</center>
...
<center>{% img /images/2016/IMAG2016111501.jpeg %}</center>
...
<center>{% img /images/2016/IMAG2016111502.jpeg %}</center>
...
<center>{% img /images/2016/IMAG2016111503.jpeg %}</center>
...
- 技术选型以开源方案为主，便于复用和客户二次开发；

- 数据模型尽量简洁，减少 ETL 代价；

- 每天十亿级别数据量下，秒级导入，秒级查询；

- 需要存储明细数据，采用 ROLAP 而不是 MOLAP 的方案。
...
<center>{% img /images/2016/IMAG2016111504.jpeg %}</center>

神策分析设计上也基本遵循这一原则。下图是神策分析的架构图：

<center>{% img /images/2016/IMAG2016111505.jpeg %}</center>
...
<center>{% img /images/2016/IMAG2016111506.jpeg %}</center>
...
<center>{% img /images/2016/IMAG2016111507.jpeg %}</center>
...
## 参考资料   
[1][神策分析的技术选型与架构实现](https://demo.sensorsdata.cn/blog/technical_implementation_of_sensors_analytics)  
