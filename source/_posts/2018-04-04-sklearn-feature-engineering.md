---   
layout: post   
title: "【Python机器学习】使用sklearn做单机特征工程"   
date: 2018-04-04 13:01   
comments: true   
...
<center>{% img /images/2018/IMAG2018040445.png %}</center>
...
<center>{% img /images/2018/IMAG2018040446.png %}</center>
<br>
...
```python
from numpy import vstack, array, nan2from sklearn.preprocessing import Imputer
...
<center>{% img /images/2018/IMAG2018040447.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040448.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040449.png %}</center>
<br>
...
#带L1和L2惩罚项的逻辑回归作为基模型的特征选择4#参数threshold为权值系数之差的阈值
...
#主成分分析法，返回降维后的数据4#参数n_components为主成分数目
...
#线性判别分析法，返回降维后的数据4#参数n_components为降维后的维数
...
原文链接: [http://www.cnblogs.com/jasonfreak/p/5448385.html](http://www.cnblogs.com/jasonfreak/p/5448385.html)
