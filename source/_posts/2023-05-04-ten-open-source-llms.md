---   
layout: post   
title: "10个开源的ChatGPT类模型简介及部分代码实践"   
date: 2023-05-04 23:51   
comments: true   
categories: 大模型   
tags: 大模型 LLaMA ChatGLM RWKV   
---   

<center>{% img /images/2023/IMAG2023050401.png %}</center>
...
2.  自主定制：它允许开发人员使用自己的数据训练大型语言模型，如果他们想应用某些主题，可以对某些主题进行一些过滤；

3.  经济实惠：开源 GPT 模型可让您训练复杂的大型语言模型，而无需担心昂贵的硬件。

4.  AI平民化：它为进一步的研究开辟了空间，可用于解决现实世界的问题。
...
<center>{% img /images/2023/IMAG2023050402.png %}</center>

该模型有4个不同参数大小的版本，具体每个版本的详细参数如下：

<center>{% img /images/2023/IMAG2023050403.png %}</center>
...
<center>{% img /images/2023/IMAG2023050404.png %}</center>
...
<center>{% img /images/2023/IMAG2023050405.png %}</center>
...
<center>{% img /images/2023/IMAG2023050406.png %}</center>
...
<center>{% img /images/2023/IMAG2023050409.png %}</center>
...
<center>{% img /images/2023/IMAG2023050410.png %}</center>

训练数据使用了46种语言、13种训练任务：

<center>{% img /images/2023/IMAG2023050411.png %}</center>

基于不同的数据集和不同网络参数，有多个不同大小和规格的模型：

<center>{% img /images/2023/IMAG2023050412.png %}</center>
...
<center>{% img /images/2023/IMAG2023050413.png %}</center>
...
<center>{% img /images/2023/IMAG2023050414.png %}</center>
...
1）高精度代码生成：支持生成Python、C++、Java、JavaScript和Go等多种主流编程语言的代码，在HumanEval-X代码生成任务上取得47%~60%求解率，较其他开源基线模型有更佳的平均性能。[DEMO](https://models.aminer.cn/codegeex/zh-CN/playground)

2）跨语言代码翻译：支持代码片段在不同编程语言间进行自动翻译转换，翻译结果正确率高，在HumanEval-X代码翻译任务上超越了其它基线模型。[DEMO](https://models.aminer.cn/codegeex/zh-CN/codeTranslator)

3）自动编程插件：CodeGeeX插件现已上架VSCode插件市场（完全免费），用户可以通过其强大的少样本生成能力，自定义代码生成风格和能力，更好辅助代码编写。[插件下载](https://marketplace.visualstudio.com/items?itemName=aminer.codegeex)

4）模型跨平台开源: 所有代码和模型权重开源开放，用作研究用途。CodeGeeX同时支持昇腾和英伟达平台，可在单张昇腾910或英伟达V100/A100上实现推理。[申请模型权重](https://models.aminer.cn/codegeex/download/request)
...
<center>{% img /images/2023/IMAG2023050415.png %}</center>

来自:https://lmsys.org/blog/2023-05-03-arena/

# 参考

【1】[LLMSurvey](https://github.com/RUCAIBox/LLMSurvey#Timeline-of-LLMs)

【2】[13 OPEN SOURCE CHATGPT MODELS: COMPLETE GUIDE](https://www.listendata.com/2023/03/open-source-chatgpt-models-step-by-step.html#id-4371b7)
