---   
layout: post   
title: "【美团】Hive SQL的编译过程详解"   
date: 2015-12-07 18:16   
comments: true   
categories: BigData   
tags: Hive SQL MapReduce 大数据   
---   

<center>{% img /images/2015/IMAG2015120700.jpeg %}</center>
...
<center>{% img /images/2015/IMAG2015120701.png %}</center>
...
<center>{% img /images/2015/IMAG2015120702.png %}</center>
...
<center>{% img /images/2015/IMAG2015120703.png %}</center>
...
<center>{% img /images/2015/IMAG2015120704.png %}</center>
...
<center>{% img /images/2015/IMAG2015120705.png %}</center>
...
<center>{% img /images/2015/IMAG2015120706.png %}</center>
...
<center>{% img /images/2015/IMAG2015120707.png %}</center>
...
<center>{% img /images/2015/IMAG2015120708.png %}</center>
...
<center>{% img /images/2015/IMAG2015120709.png %}</center>
...
<center>{% img /images/2015/IMAG2015120710.png %}</center>

图中 TS=TableScanOperator RS=ReduceSinkOperator JOIN=JoinOperator

1. 生成中间表与dim.user的Join操作树

<center>{% img /images/2015/IMAG2015120711.png %}</center>

1. 根据QB2 QBParseInfo#destToWhereExpr 生成FilterOperator。此时QB2遍历完成。

下图中SelectOperator在某些场景下会根据一些条件判断是否需要解析字段。

<center>{% img /images/2015/IMAG2015120712.png %}</center>

** 图中 FIL= FilterOperator SEL= SelectOperator ** 

1. 根据QB1的QBParseInfo#destToGroupby生成ReduceSinkOperator + GroupByOperator

<center>{% img /images/2015/IMAG2015120713.png %}</center>
...
<center>{% img /images/2015/IMAG2015120714.png %}</center>
...
<center>{% img /images/2015/IMAG2015120715.png %}</center>

### NonBlockingOpDeDupProc优化器

NonBlockingOpDeDupProc优化器合并SEL-SEL 或者 FIL-FIL 为一个Operator

<center>{% img /images/2015/IMAG2015120716.png %}</center>
...
<center>{% img /images/2015/IMAG2015120717.png %}</center>
...
<center>{% img /images/2015/IMAG2015120718.png %}</center>
...
<center>{% img /images/2015/IMAG2015120719.png %}</center>
...
<center>{% img /images/2015/IMAG2015120720.png %}</center>
...
<center>{% img /images/2015/IMAG2015120721.png %}</center>
...
<center>{% img /images/2015/IMAG2015120722.png %}</center>
...
<center>{% img /images/2015/IMAG2015120723.png %}</center>
...
<center>{% img /images/2015/IMAG2015120724.png %}</center>
...
<center>{% img /images/2015/IMAG2015120725.png %}</center>

继续从TS[du]向下遍历，当opStack={TS[du], RS[7]}时，满足规则R2 TS%.*RS%

此时将JOIN[8]保存为MapReduceTask[Stage-5]的ReduceWork时，发现在一个Map对象保存的Operator与MapReduceWork对象关系的Map 对象中发现，JOIN[8]已经存在。此时将MapReduceTask[Stage-2]和MapReduceTask[Stage-5]合并为一个MapReduceTask

<center>{% img /images/2015/IMAG2015120726.png %}</center>

同理从最后一个根节点TS[c]开始遍历，也会对MapReduceTask进行合并

<center>{% img /images/2015/IMAG2015120727.png %}</center>

### 切分Map Reduce阶段

最后一个阶段，将MapWork和ReduceWork中的OperatorTree以RS为界限剪开

<center>{% img /images/2015/IMAG2015120728.png %}</center>

### OperatorTree生成MapReduceTask全貌

最终共生成3个MapReduceTask，如下图

<center>{% img /images/2015/IMAG2015120729.png %}</center>
...
<center>{% img /images/2015/IMAG2015120730.png %}</center>
...
<center>{% img /images/2015/IMAG2015120731.png %}</center>
...
<center>{% img /images/2015/IMAG2015120732.png %}</center>

MapReduceTask经过变换后的执行计划如下图所示

<center>{% img /images/2015/IMAG2015120733.png %}</center>

### MapJoinResolver优化器

MapJoinResolver优化器遍历Task Tree，将所有有local work的MapReduceTask拆成两个Task

<center>{% img /images/2015/IMAG2015120734.png %}</center>

最终MapJoinResolver处理完之后，执行计划如下图所示

<center>{% img /images/2015/IMAG2015120735.png %}</center>
...
# 参考资料   
[1][Hive SQL的编译过程 - 美团技术团队](https://tech.meituan.com/2014/02/12/hive-sql-to-mapreduce.html)  
[2][Antlr](http://www.antlr.org/)  
[3][Hive Wiki](https://cwiki.apache.org/confluence/display/Hive/Home)  
