...
转载自知乎，原文链接：[从谷歌到阿里，谈谈工业界推荐系统多目标预估的两种范式](https://zhuanlan.zhihu.com/p/125507748)
...
<center>{% img /images/2020/IMAG2020042001.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042002.webp %}</center><br>

而如果你的任务是做一个狗的分类，同时做汽车的分类，采用Hard parameter sharing的方法，底层的shared layer 很难学到两者共同的模式，多目标任务也很难学好。

<center>{% img /images/2020/IMAG2020042003.webp %}</center><br>

谷歌在MMOE论文中的实验显示，任务相关性越高，模型的loss可以降到更低。

<center>{% img /images/2020/IMAG2020042004.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042005.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042006.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042007.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042008.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042009.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042010.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042011.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042012.webp %}</center><br>

事实上，通过观察下面公式中pctcvr、pctr、pcvr之间的关系，可以找到解决上面问题的方法。

<center>{% img /images/2020/IMAG2020042013.png %}</center><br>

上面公式可以转化为

<center>{% img /images/2020/IMAG2020042014.webp %}</center><br>
...
<center>{% img /images/2020/IMAG2020042015.webp %}</center><br>

ESSM巧妙的通过将除法改成乘法来解决上面的问题。它引入了pctr和pctcvr两个辅助任务，训练时，loss为两者相加。

<center>{% img /images/2020/IMAG2020042016.png %}</center><br>

ESSM是一种较为的通用的任务序列依赖关系建模的方法，除此之外，阿里的DBMTL 、ESM^2等工作都属于这一范式。
...
<center>{% img /images/2020/IMAG2020042017.png %}</center><br>

或者

<center>{% img /images/2020/IMAG2020042018.png %}</center><br>
