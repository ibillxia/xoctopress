---   
layout: post   
title: "Apache Spark的API三剑客：RDD、DataFrame和Dataset"   
date: 2019-09-17 15:15   
comments: true   
categories: BigData   
tags: Spark RDD DataFrame Dataset 大数据   
---   
...
<center>{% img /images/2019/IMAG2019091701.webp %}</center><br>
...
<center>{% img /images/2019/IMAG2019091702.webp %}</center><br>
...
<center>{% img /images/2019/IMAG2019091703.png %}</center><br>
...
<center>{% img /images/2019/IMAG2019091704.png %}</center><br>
...
1. 在这时候，Spark 把你的数据用“DataFrame = Dataset[Row]”进行转换，变成一种通用行对象的集合，因为这时候它还不知道具体的类型；

1. 然后，Spark 就可以按照类 DeviceIoTData 的定义，转换出“Dataset[Row] -> Dataset[DeviceIoTData]”这样特定类型的 Scala JVM 对象了。
...
<center>{% img /images/2019/IMAG2019091705.png %}</center><br>
...
<center>{% img /images/2019/IMAG2019091706.gif %}</center><br>
...
<center>{% img /images/2019/IMAG2019091707.png %}</center><br>
...
<center>{% img /images/2019/IMAG2019091708.png %}</center><br>
...
[且谈 Apache Spark 的 API 三剑客：RDD、DataFrame 和 Dataset](https://www.infoq.cn/news/three-apache-spark-apis-rdds-dataframes-and-datasets)
...
[databricks example](https://docs.cloud.databricks.com/docs/spark/1.6/index.html#examples/Dataset%20Wordcount.html)
