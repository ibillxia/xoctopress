...
<center>{% img /images/2018/IMAG2018040401.jpeg %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040402.png %}</center>
<br><br>
可以用matplotlib画出图形：

<center>{% img /images/2018/IMAG2018040403.png %}</center>
<br><br>
<center>{% img /images/2018/IMAG2018040404.png %}</center>
<br><br>
上图中，'x'轴表示匹萨直径，'y'轴表示匹萨价格。能够看出，匹萨价格与其直径正相关，这与我们的日常经验也比较吻合，自然是越大越贵。下面就用scikit-learn来构建模。

<center>{% img /images/2018/IMAG2018040405.png %}</center>
<br><br>
预测一张12英寸匹萨价格：$13.68。
...
<center>{% img /images/2018/IMAG2018040406.png %}</center>
<br><br>
<center>{% img /images/2018/IMAG2018040407.png %}</center>
<br><br>
...
<center>{% img /images/2018/IMAG2018040408.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040409.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040410.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040411.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040412.png %}</center>
<br>
其中， 是观测值， 是预测值。残差平方和计算如下：

<center>{% img /images/2018/IMAG2018040413.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040414.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040415.png %}</center>
<br>
Numpy里面有var方法可以直接计算方差，ddof参数是贝塞尔(无偏估计)校正系数（Bessel'scorrection），设置为1，可得样本方差无偏估计量。

<center>{% img /images/2018/IMAG2018040416.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040417.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040418.png %}</center>
<br>
现在有了方差和协方差，就可以计算相关系统贝塔了。

<center>{% img /images/2018/IMAG2018040419.png %}</center>
<br>
算出贝塔后，就可以计算阿尔法了：
...
<center>{% img /images/2018/IMAG2018040420.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040421.png %}</center>
<br>
=56.8

然后，计算残差平方和，和前面的一样：

<center>{% img /images/2018/IMAG2018040422.png %}</center>
<br>
最后用下面的公式计算R方：

<center>{% img /images/2018/IMAG2018040423.png %}</center>
<br>
R方是0.6620说明测试集里面过半数的价格都可以通过模型解释。现在，用scikit-learn来验证一下。LinearRegression的score方法可以计算R方：

<center>{% img /images/2018/IMAG2018040424.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040425.png %}</center>
<br>
写成矩阵形式如下：

一元线性回归可以写成如下形式：

<center>{% img /images/2018/IMAG2018040426.png %}</center>
<br>
其中，Y是训练集的响应变量列向量，贝塔是模型参数列向量。X称为设计矩阵，是m*n维训练集的解释变量矩阵。m是训练集样本数量，n是解释变量个数。增加辅料的匹萨价格预测模型训练集如下表所示：

<center>{% img /images/2018/IMAG2018040427.png %}</center>
<br>
同时要升级测试集数据：

<center>{% img /images/2018/IMAG2018040428.png %}</center>
<br>
学习算法评估三个参数的值：两个相关因子和一个截距。 的求解方法可以通过矩阵运算来实现。

矩阵没有除法运算，所以用矩阵的转置运算和逆运算来实现：

<center>{% img /images/2018/IMAG2018040429.png %}</center>
<br>
通过Numpy的矩阵操作就可以完成：

<center>{% img /images/2018/IMAG2018040430.png %}</center>
<br>
[[ 1.1875 ][ 1.01041667][ 0.39583333]]

有了参数，就来更新价格预测模型：

<center>{% img /images/2018/IMAG2018040431.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040432.png %}</center>
<br>
二次回归（Quadratic Regression），即回归方程有个二次项，公式如下：

<center>{% img /images/2018/IMAG2018040433.png %}</center>
<br>
只用一个解释变量，但是模型有三项，通过第三项（二次项）来实现曲线关系。PolynomialFeatures转换器可以用来解决这个问题。代码如下：

<center>{% img /images/2018/IMAG2018040434.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040435.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040436.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040437.png %}</center>
<br>
[[ 1 6 36 216][ 1 8 64 512][ 1 10 100 1000][ 1 14 196 2744][ 1 18 324 5832]][[ 1 6 36 216][ 1 8 64 512][ 1 11 121 1331][ 1 16 256 4096]]二次回归 r-squared 0.867544458591三次回归 r-squared 0.835692454062

七次回归，效果如下图所示：

<center>{% img /images/2018/IMAG2018040438.png %}</center>
<br>
<center>{% img /images/2018/IMAG2018040439.png %}</center>
<br>
二次回归 r-squared 0.867544458591
...
<center>{% img /images/2018/IMAG2018040442.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040443.png %}</center>
<br>
...
<center>{% img /images/2018/IMAG2018040444.png %}</center>
<br>
交叉验证R方值: [ 0.64102297 0.65659839 0.80237287 0.67294193 0.57322387]交叉验证R方均值: 0.669232006274测试集R方值: 0.787333341357
...
原文链接 [https://cloud.tencent.com/developer/article/1030276](https://cloud.tencent.com/developer/article/1030276)
